...
#define FREQ_PERIODS    (double[FREQ_SIZE])  { 1000000, 500000, 250000, 125000, 62500, 31250, 15625, 7812, 3906, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1 } // Full cycle period in microseconds
