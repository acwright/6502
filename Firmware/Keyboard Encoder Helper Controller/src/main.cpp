...
void loop() {
  ...
  uint8_t ascii = buffer.shift();

  // Write ASCII value to PORT A
  digitalWrite(D0, (ascii >> 0) & 1);
  digitalWrite(D1, (ascii >> 1) & 1);
  digitalWrite(D2, (ascii >> 2) & 1);
  digitalWrite(D3, (ascii >> 3) & 1);
  digitalWrite(D4, (ascii >> 4) & 1);
  digitalWrite(D5, (ascii >> 5) & 1);
  digitalWrite(D6, (ascii >> 6) & 1);
  digitalWrite(D7, (ascii >> 7) & 1);
