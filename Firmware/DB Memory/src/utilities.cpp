...
word readAddress() {
  ...
  // return  (digitalReadFast(A15) << 15) + 
  //         (digitalReadFast(A14) << 14) + 
  //         (digitalReadFast(A13) << 13) + 
  //         (digitalReadFast(A12) << 12) + 
  //         (digitalReadFast(A11) << 11) + 
  //         (digitalReadFast(A10) << 10) + 
  //         (digitalReadFast(A9) << 9) +
  //         (digitalReadFast(A8) << 8) +  
  //         (digitalReadFast(A7) << 7) + 
  //         (digitalReadFast(A6) << 6) + 
  //         (digitalReadFast(A5) << 5) + 
  //         (digitalReadFast(A4) << 4) + 
  //         (digitalReadFast(A3) << 3) + 
  //         (digitalReadFast(A2) << 2) + 
  //         (digitalReadFast(A1) << 1) + 
  //         digitalReadFast(A0);
