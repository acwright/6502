...
; This non-delay ECHO routine for 6551 is 2 bytes too long...
;
; ECHO:
;   PHA
;   STA     ACIA_DATA      ; Output character.
; TXWAIT:        
;   LDA     ACIA_STATUS    ; Decrement A.
;   AND     #%00010000     ; Check if tx buffer not empty
;   BEQ     TXWAIT         ; Loop if tx buffer not empty
;   PLA                    ; Restore A.
;   RTS                    ; Return.
;
; We can change lines 23-25 to:
;   LDY     #$8B           ; No parity, no echo, no interrupts.
;  STY     ACIA_CMD
;  ; LDA     #$1B           ; Begin with escape. REMOVE THIS
; But this turns on parity for R6551 IC...
