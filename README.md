...
- Power supply: 5V DC, 2-3A (depending on system configuration)
- USB cables (Mini-USB, Micro-USB, or USB-C depending on microcontrollers used)
- **EEPROM programmer** (TL866II Plus, TL866A, or similar) for programming ROM chips (28C256, 27C256)

**Recommended:**
- Magnifying glass or helping hands
- Desoldering pump or wick (for corrections)
- Flux pen
- Anti-static wrist strap
- Digital caliper (for mechanical measurements)

### Software Tools

**PCB Design:**
- [KiCad 7.0+](https://www.kicad.org/) (for viewing/editing schematics and PCB layouts)
...
- Serial terminal software:
  - [CoolTerm](https://freeware.the-meiers.org/) (macOS/Windows/Linux)
  - Arduino Serial Monitor
  - `screen` or `minicom` (Linux/macOS)

**Optional Development Tools:**
- [Visual Studio Code](https://code.visualstudio.com/) with PlatformIO extension
- [Teensy Loader](https://www.pjrc.com/teensy/loader.html) (for Teensy microcontrollers)
- [AVRDUDE](https://www.nongnu.org/avrdude/) (for AVR microcontroller programming)
- Git (for version control and cloning repositories)

### Component Sourcing

**PCB Manufacturing:**
- [JLCPCB](https://jlcpcb.com/) account (for ordering PCBs with assembly)

**Electronic Components:**
- Most components are sourced by JLCPCB for SMD assembly
- Through-hole components: [Mouser](https://www.mouser.com/), [Digikey](https://www.digikey.com/), [Jameco](https://www.jameco.com/)
- Specialized modules:
  - [ARMSID](https://retrocomp.cz/produkt?id=2) (sound module)
  - [Pico9918](https://github.com/visrealm/pico9918) (VGA graphics, build yourself or purchase)
  - Teensy 4.1 from [PJRC](https://www.pjrc.com/store/teensy41.html)

### Knowledge Prerequisites

**Minimum:**
- Basic electronics understanding (voltage, current, resistance)
- Ability to read datasheets
- Basic soldering skills

**Helpful:**
- Understanding of digital logic (gates, flip-flops, counters)
- Familiarity with 6502 assembly language
- Experience with microcontroller programming (Arduino, PlatformIO)
- Knowledge of serial protocols (UART, SPI, I2C)
- Understanding of memory mapping and address decoding
